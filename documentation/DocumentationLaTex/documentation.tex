...
\begin{figure}[tpbh]
	\centering
  \includegraphics[width=\textwidth, trim=25mm 60mm 35mm 35mm, clip]{./Diagrammes/diagrammeDeClasses.pdf}
  %TRIM = LINKS UNTEN RECHTS OBEN
...
\begin{itemize}
\item \textit{Les variables}\vspace{0.3cm}\\
\begin{tabular}{ll} %l/c/r
 ...
 \end{tabular}
 \vspace{0.5cm}
\item \textit{Les méthodes}\vspace{0.3cm}\\
\begin{tabular}{ll} %l/c/r
   \textbf{Lehrstuhl} & Professor \\ 
   \textbf{Lehrstuhl} & Maier \\ 
   \textbf{Lehrstuhl} & M"uller \\ 
