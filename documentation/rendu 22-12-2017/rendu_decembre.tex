...
Rôle & cherche l'indice d'une lettre donnée dans une liste donnée\\
Paramètre & aucun\\
Retour & XXXXXXXX\\
Appelé par & XXXXXXXX\\
Appelle & XXXXXXXX\\
...
Ce module est responsable du déroulement du programme. De plus il s'occupe du formatage du texte de l'utilisateur.
\vspace{0.3cm}

\begin{longtable}{ll}
\textbf{normalise\_letter} & (ligne X)\\
Déclaration & normalise\_letter(x)\\
Rôle & normalise une lettre si elle est par exemple un caractère spécial\\
Paramètre & aucun\\
Retour & XXXXXXXX\\
Appelé par & XXXXXXXX\\
Appelle & XXXXXXXX\\
...
\newpage
% tests
\textbf{Explications du module \textit{tests:}}\\
Ce module contient toutes les fonctions qui sont utilisées pour tester le code du programme.
\vspace{0.3cm}

\begin{longtable}{ll}
\textbf{\textit{tests text\_module}}\\
\textbf{test\_caesar} & (ligne X)\\
Déclaration & test\_caesar()\\
Rôle & XXXXXXXX\\
Paramètre & aucun\\
Retour & XXXXXXXX\\
Appelé par & XXXXXXXX\\
...
\cr
\cr
\textbf{test\_create\_vigenere\_table} & (ligne X)\\
Déclaration & test\_create\_vigenere\_table()\\
Rôle & XXXXXXXX\\
Paramètre & aucun\\
Retour & XXXXXXXX\\
Appelé par & XXXXXXXX\\
...
\cr
\cr
\textbf{test\_vigenere} & (ligne X)\\
Déclaration & test\_vigenere()\\
Rôle & XXXXXXXX\\
Paramètre & aucun\\
Retour & XXXXXXXX\\
Appelé par & XXXXXXXX\\
...
\cr
\cr
\textbf{test\_enigma} & (ligne X)\\
Déclaration & test\_enigma()\\
Rôle & XXXXXXXX\\
Paramètre & aucun\\
Retour & XXXXXXXX\\
Appelé par & XXXXXXXX\\
...
\cr
\cr
\textbf{\textit{tests main\_module}}\\
\textbf{test\_format\_and\_normalise} & (ligne X)\\
Déclaration & test\_format\_and\_normalise()\\
Rôle & XXXXXXXX\\
Paramètre & aucun\\
Retour & XXXXXXXX\\
Appelé par & XXXXXXXX\\
...
\cr
\cr
\textbf{test\_run} & (ligne X)\\
Déclaration & test\_run()\\
Rôle & XXXXXXXX\\
Paramètre & aucun\\
Retour & XXXXXXXX\\
Appelé par & XXXXXXXX\\
...
\cr
\cr
\textbf{\textit{lancer tous les tests}}\\
\textbf{run\_all\_tests} & (ligne X)\\
Déclaration & run\_all\_tests()\\
Rôle & XXXXXXXX\\
Paramètre & aucun\\
Retour & XXXXXXXX\\
Appelé par & XXXXXXXX\\
